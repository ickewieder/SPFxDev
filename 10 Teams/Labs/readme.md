...
5. The next set of prompts ask for specific information about your web part:
    ...
    * Accept the default **No JavaScipt web framework** option for the framework, and then select Enter to continue.
      ...
      ![Yeoman prompts](_images/yeoman-sp-teams-prompts.png)
    ...
    > Execute: `npm i --save-dev @microsoft/teams-js`
...
Starting with the SharePoint Framework v1.8, scaffolding will also include additional **./teams** folder in the solution structure, with default configuration for your web parts, so that you can get started with Teams tab development as easily as possible.
  ...
  ![Solution structure](_images/sp-teams-solution-structure.png)
...
These images will be used as icons in Microsoft Teams.
 ...
 > Image sizes are: 192 x 192 and 32 x 32 pixels if you want to provide you own images
...
1. Upload or drag and drop the **teams-tab-webpart.sppkg** to the app catalog.
    ...
    ![Upload solution to app catalog](_images/sp-teams-solution-upload-catalog.png)
    ...
    ![Trust client-side solution deployment](_images/sp-teams-upload-solution-deploy.png) 
...
1. Create a Microsoft Teams app manifest file by following the instructions detailed here: [Create Microsoft Teams manifest manually for a web part and deploy it to Microsoft Teams](https://github.com/SharePoint/sp-dev-docs/blob/master/docs/spfx/web-parts/guidance/creating-team-manifest-manually-for-webpart.md).

> You can create your Teams App Manifest using `App Studio for Teams` or use the sample `manifest.json` in the chapters root folder

![AppStudio](_images/TeamsAppManifest.png)
...
1. Move to a channel in a team. In the below picture we have activated **General** channel in **Team**
    ...
    ![Channel activated](_images/sp-teams-channel-activated.png)
...
1. Select your custom tab called **MyFirstTeamTab** in the list
    ...
    ![Add a tab](_images/sp-teams-add-a-tab.png)
...
![Custom tab added](_images/sp-teams-custom-tab-added.png)
